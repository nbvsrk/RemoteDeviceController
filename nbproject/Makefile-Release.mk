...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/supervision: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/supervision ${OBJECTFILES} ${LDLIBSOPTIONS} -lcurl -lxml2 -I/usr/include/libxml2
...
${OBJECTDIR}/MEKCamStreamNRecord.o: MEKCamStreamNRecord.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/MEKCamStreamNRecord.o MEKCamStreamNRecord.cpp
